...
## 1. Project Intent
The Crow Buddy mod aims to add a vanilla-plus, tameable crow entity to Minecraft. It mirrors real-life crow presence through biome-specific spawning and introduces unique crow-centric mechanics like scavenging, shoulder-perching, and a sophisticated swarm intelligence system.

## 2. Core Concept: The Crow
A vanilla-plus, tameable entity that shares behaviors with Parrots (flight, shoulder-sitting) while introducing unique crow-centric mechanics. It is designed to be a highly interactive and social mob, with behaviors that respond to the player and the environment.
...
- **Interactivity:** Through scavenging, perching, and breeding, crows become an integral part of the player's ecosystem.
...
- **Phase 4: World & Environment** (In Progress)
- **Phase 5: Polishing & Verification** (Upcoming)
